...
import 'package:flakka_build_runner/src/command_runner.dart';
...
void main() {
  group('FlakkaBuildRunnerCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FlakkaBuildRunnerCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FlakkaBuildRunnerCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FlakkaBuildRunnerCommandRunner();
